...
const Profile = async () => {
  ...
  return (
    <main className="min-lg:w-3/4">
      <section className="flex justify-between gap-4 max-sm:flex items-center">
        ...
        <div className="flex gap-4">
          <div className="border border-black runded-lg flex flex-col gap-2 p-3 h-fit">
       ...
       <Accordion type="multiple" >
          <AccordionItem value="recent">
            <AccordionTrigger className="text-2xl font-bold">Reecent Sessions</AccordionTrigger>
            <AccordionContent>
